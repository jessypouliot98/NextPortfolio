...
export const StylishCode: React.FC<StylishCodeProps> = (props) => {
  ...
  return (
    <div className={clsx('stylish-box', 'p-5 shadow-lg bg-gradient-to-br from-blue-300 via-blue-400 to-orange-300 rounded-lg', props.className)}>
      <div className="relative group">
        <Code {...props} className="rounded-lg shadow">
          {props.children}
        </Code>
        <div className="transition opacity-0 group-hover:opacity-100 py-1 px-2 absolute top-0 right-0">
